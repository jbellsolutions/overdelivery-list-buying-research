...
3. **Static HTML as the web entry point:** `index.html` gives the reader a short executive conclusion, category map, diligence checklist, verification limits, and direct links into the full Markdown, CSV, JSON, and raw-capture corpus.
...
- The here.now URL returns HTTP 200 and renders the title **Over Delivery List-Buying Research**.
- The web snapshot exposes working relative links to the principal deliverables.
